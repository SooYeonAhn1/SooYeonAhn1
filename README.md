...
To Summarize:
```
- Programming Languages (Sorted by Proficiency): C/C++, Python, JavaScript, Java
...
I'm open to opportunities where I can learn and contribute at the same time.

If you think I am a good fit for any positions you have in mind, or want to learn more about my technical background, you can check out [my resume](https://sooyeonahn1.github.io/Resources/SooYeon%20Ahn_October%202025_Resume%20-%20GitHub.pdf).

Feel free to reach out via email!
<!--
**SooYeonAhn1/SooYeonAhn1** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
